...
L["worldBaseMipTooltip"] = "Determines the detail level of terrain textures. (Game may be unresponsive for a short time after switching.)"
L["terrainMipLevelTooltip"] = "Toggles the quality of terrain texture blending. (Game may be unresponsive for a short time after switching to 'low' while worldBaseMipTooltip is 'high'.)"
L["componentTextureLevelTooltip"] = "Determines the detail level of textures used for player gear such as armor. Only models of newer WoW expansions seem to be affected. (Game may be unresponsive for a short time after switching to 'low' while worldBaseMipTooltip is 'high'.)"
